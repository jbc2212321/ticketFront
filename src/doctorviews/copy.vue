...
<!--    <div id="UploadCsv">-->
<!--        <template>-->
<!--            &lt;!&ndash;            <span class="demonstration">科室：</span>&ndash;&gt;-->
<!--            &lt;!&ndash;            <el-select v-model="value0" placeholder="选择科室" >&ndash;&gt;-->
<!--            &lt;!&ndash;                <el-option&ndash;&gt;-->
<!--            &lt;!&ndash;                        v-for="item in offices"&ndash;&gt;-->
...
<!--        </template>-->
<!--        <br><br>-->
<!--        &lt;!&ndash;        action="http://localhost:8096/user/upload"&ndash;&gt;-->
<!--        <el-upload-->
<!--                class="upload-demo"-->
...
<!--            &lt;!&ndash;            <div slot="tip" class="el-upload__tip">只能上传csv文件</div>&ndash;&gt;-->
<!--        </el-upload>-->
...
<!--                    &lt;!&ndash; head start &ndash;&gt;-->
<!--                    <div class="invoiceHeader">-->
<!--                        <div class="invoiceHeader-left">-->
<!--                            <ul class="headerLeft">-->
<!--                                <li>-->
<!--                                    &lt;!&ndash; <img src="./qrcode.png" alt=""> &ndash;&gt;-->
<!--                                    <br>-->
<!--                                    <br>-->
<!--                                    <br><br><br>-->
<!--                                </li>-->
...
<!--                            </li>-->
<!--                            &lt;!&ndash;                        <li>&ndash;&gt;-->
<!--                            &lt;!&ndash;                            <label> 校&nbsp;&nbsp;验&nbsp;&nbsp;码： </label><span>11111 22222 33333 44444</span>&ndash;&gt;-->
<!--                            &lt;!&ndash;                        </li>&ndash;&gt;-->
<!--                        </ul>-->
<!--                    </div>-->
<!--                    &lt;!&ndash; head end &ndash;&gt;-->
<!--                    &lt;!&ndash; invoice body start &ndash;&gt;-->
<!--                    <div class="invoiceBody">-->
<!--                        <div class="userInfo">-->
<!--                            <div class="buy">购买方</div>-->
<!--                            <ul>-->
<!--                                <li>-->
<!--                                    <label>名&nbsp;称：</label><input type="text" name="PurchaserName"-->
<!--                                                                   v-model="PurchaserName">-->
<!--                                </li>-->
<!--                                <li>-->
<!--                                    <label>纳税人识别号：</label><input type="text" name="PurchaserRegisterNum"-->
<!--                                                                 v-model="PurchaserRegisterNum">-->
<!--                                </li>-->
<!--                                <li>-->
<!--                                    <label>地址、&nbsp;&nbsp;&nbsp;电话：</label><input type="text" name="PurchaserAddress"-->
<!--                                                                                  v-model="PurchaserAddress">-->
<!--                                </li>-->
<!--                                <li>-->
<!--                                    <label>开户行及账号：</label><input type="text" name="PurchaserBank"-->
<!--                                                                 v-model="PurchaserBank">-->
<!--                                </li>-->
<!--                            </ul>-->
...
<!--                                    <td>-->
<!--                                        <el-input type="textarea" v-model="CommodityName" rows="5"></el-input>-->
<!--                                    </td>-->
<!--                                    <td>-->
<!--                                        <el-input type="textarea" v-model="CommodityType" rows="5"></el-input>-->
<!--                                    </td>-->
<!--                                    <td>-->
<!--                                        <el-input type="textarea" v-model="CommodityUnit" rows="5"></el-input>-->
<!--                                    </td>-->
<!--                                    <td>-->
<!--                                        <el-input type="textarea" v-model="CommodityNum" rows="5"></el-input>-->
<!--                                    </td>-->
<!--                                    <td>-->
<!--                                        <el-input type="textarea" v-model="CommodityPrice" rows="5"></el-input>-->
<!--                                    </td>-->
<!--                                    <td>-->
...
<!--                                    <td></td>-->
<!--                                    <td>-->
<!--                                        <el-input type="textarea" v-model="TotalAmount" rows="1"></el-input>-->
<!--                                    </td>-->
<!--                                    <td></td>-->
<!--                                    <td>-->
<!--                                        <el-input type="textarea" v-model="TotalTax" rows="1"></el-input>-->
<!--                                    </td>-->
<!--                                </tr>-->
<!--                                <tr class="GoodsTotal">-->
<!--                                    <td>价税合计(大写)</td>-->
...
<!--                                            <div type="text" style="width: 60%"><input type="text" name="AmountInWords"-->
...
<!--                                <ul>-->
<!--                                    <li>-->
<!--                                        <label>名&nbsp;称：</label><input type="text" name="SellerName"-->
<!--                                                                       v-model="SellerName">-->
<!--                                    </li>-->
<!--                                    <li>-->
<!--                                        <label>纳税人识别号：</label><input type="text" name="SellerRegisterNum"-->
<!--                                                                     v-model="SellerRegisterNum">-->
<!--                                    </li>-->
<!--                                    <li>-->
<!--                                        <label>地址、&nbsp;&nbsp;&nbsp;电话：</label><input type="text" name="SellerAddress"-->
